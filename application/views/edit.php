   ...
   <form class="form-group" name="updateUser" method="POST" action="<?= base_url('User/edit/' . $user['acc_id']); ?>">
      ...
      <div class="form-group">
         <label for="acc_username">Nom
            <input type="text" id="acc_username" class="form-group shadow transition" name="acc_username" value="<?= set_value('acc_username', $user['acc_username']); ?>">
         </label>
      ...
      <div class="form-group">
         <label for="acc_pass">Mot de passe
            <input type="password" id="acc_pass" class="form-group shadow transition" name="acc_pass" value="<?= set_value('acc_pass', $user['acc_pass']); ?>">
         </label>
         <?= form_error('acc_pass'); ?>
      </div>
      ...
      <div class="form-group">
         <label for="acc_email">Email
            <input type="email" id="acc_email" class="form-group shadow transition" name="acc_email" value="<?= set_value('acc_email', $user['acc_email']); ?>">
         </label>
